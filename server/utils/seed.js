...
const sampleExperiences = [
  ...
  {
    type: 'skills',
    items: ['React', 'Node.js', 'Express', 'MongoDB', 'Tailwind CSS', 'TypeScript', 'Docker', 'Git'],
    order: 0,
  },
  {
    type: 'project',
    ...
    description:
      'A full-stack ticketing and event discovery platform with real-time seat selection and admin dashboards.',
    highlights: ['Handled 20k concurrent RSVPs during launch.', 'Integrated Stripe payments and PDF ticket generation.'],
    techStack: ['React', 'Node.js', 'MongoDB', 'Stripe'],
    link: 'https://github.com/HKRAmarSingh19',
    order: 0,
  },
  {
    type: 'certification',
    ...
    description: 'Validated cloud architecture design, cost optimisation and security best practices.',
    link: 'https://aws.amazon.com/certification/',
    order: 0,
  },
  {
    type: 'achievement',
    title: 'Hackathon — Best Use of MERN Stack',
    organization: 'CodeSprint 2023',
    location: 'San Jose, CA',
    startDate: '2023',
    endDate: '2023',
    current: false,
    description: 'Won Best Use of the MERN stack for a real-time collaboration tool built in 36 hours.',
    highlights: [],
    order: 0,
  },
  // A legacy `award` row to prove backward compatibility (groups under Achievements).
  {
    type: 'award',
    ...
    endDate: '2024',
    current: false,
    description: 'Recognised for leading the platform rearchitecture initiative.',
    order: 0,
  },
  {
    type: 'leadership',
    title: 'Mentor & Technical Lead',
    organization: 'ACM Student Chapter',
    location: 'San Jose, CA',
    startDate: '2020',
    endDate: '2021',
    current: false,
    description: 'Led a 12-member student chapter and organised quarterly web development workshops.',
    highlights: ['Grew chapter membership by 60%.', 'Ran recruitment and onboarding for new members.'],
    order: 0,
  },
  {
    type: 'coding',
    profiles: [
      { label: 'GitHub', url: 'https://github.com/HKRAmarSingh19' },
      { label: 'LeetCode', url: 'https://leetcode.com/hkramar73' },
      { label: 'Codolio', url: 'https://codolio.com/profile/hkramar73' },
      { label: 'HackerRank', url: 'https://www.hackerrank.com/hkramar73' },
    ],
    order: 0,
  },
];
